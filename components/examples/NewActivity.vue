  ...
  <div class="new-activity">
    <el-form :model="formData"
      ...
      <el-row type="flex"
        ...
        <el-col :xs="24"
          :sm="10">
          <el-form-item :label="$t('activity.account')"
            prop="account">
      ...
      <el-row type="flex"
        ...
        <el-col :xs="24"
          :sm="10">
          <el-form-item :label="$t('activity.tag')"
            prop="label">
            <el-select v-model="formData.label"
              multiple
              filterable
              allow-create
              :placeholder="$t('activity.holder.tag')">
        ...
        <el-col :xs="24"
          :sm="{span: 3, offset: 2}">
          <el-form-item :label="$t('activity.instDist')"
            prop="delivery">
            <el-switch active-text=""
              inactive-text=""
              v-model="formData.delivery"></el-switch>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row type="flex"
      ...
      <el-row type="flex"
        ...
        <el-col :xs="24"
          :sm="10">
          <el-form-item :label="$t('activity.rate')"
            prop="rate">
        ...
        <el-col :xs="24"
          ...
          <el-form-item :label="$t('activity.organizer')"
            prop="organizer">
            <el-cascader :options="organizers"
          ...
          <el-form-item :label="$t('activity.date')"
            ...
            <el-col :span="11">
              <el-form-item prop="date1">
                <el-date-picker :placeholder="$t('activity.holder.date')"
            ...
            <el-col :span="11">
              <el-form-item prop="date2">
                <el-time-picker :placeholder="$t('activity.holder.time')"
      ...
      <el-row type="flex"
        ...
        <el-button type="primary"
          @click="submit('newActivity')">{{$t('activity.create')}}</el-button>
...
export default {
    ...
    return {
      formRules: {
        account: [
          {
            required: true,
            message: this.$t("activity.rule.account.required"),
            trigger: "blur"
          },
          {
            min: 6,
            message: this.$t("activity.rule.account.length"),
            trigger: "blur"
          }
        ],
        region: [
          {
            required: true,
            message: this.$t("activity.rule.region.required"),
            trigger: "change"
          }
        ],
        date1: [
          {
            type: "date",
            required: true,
            message: this.$t("activity.rule.date1.required"),
            trigger: "change"
          }
        ],
        date2: [
          {
            type: "date",
            required: true,
            message: this.$t("activity.rule.date2.required"),
            trigger: "change"
          }
        ],
        type: [
          {
            type: "array",
            required: true,
            message: this.$t("activity.rule.type.required"),
            trigger: "change"
          }
        ],
        priority: [
          {
            required: true,
            message: this.$t("activity.rule.priority.required"),
            trigger: "change"
          }
        ],
        rate: [
          {
            ...
            min: 1,
            required: true,
            message: this.$t("activity.rule.rate.required"),
            trigger: "change"
          }
        ],
        desc: [
          {
            required: true,
            message: this.$t("activity.rule.desc.required"),
            trigger: "blur"
          }
        ]
      }
  ...
  computed: {
    ...mapState("examples", ["labels", "cities", "organizers"])
  },
  methods: {
    submit(formName) {
      /**
